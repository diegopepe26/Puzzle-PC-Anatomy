...
{
    public GameObject cpu, expansion, video, chipset, ram, batteriaCMOS, bios, cpuBlack, expansionBlack, videoBlack, chipsetBlack, ramBlack, batteriaCMOSBlack, biosBlack;
    
    public TextMeshProUGUI cpuText, expansionText, videoText, chipsetText, ramText, batteriaCMOSText, biosText;
    ...
    private Vector2 cpuInitialPos, expansionInitialPos, videoInitialPos, chipsetInitialPos, ramInitialPos, batteriaCMOSInitialPos, biosInitialPos;

    public bool cpuLocked, expansionLocked, videoLocked, chipsetLocked, ramLocked, batteriaCMOSLocked, biosLocked;
